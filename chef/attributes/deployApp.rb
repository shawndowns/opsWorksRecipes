...
#ode['java']['ibm']['accept_ibm_download_terms'] # Indicates that you accept IBM's EULA (for java::ibm)
...
node['java']['accept_license_agreement'] = true # Indicates that you accept the EULA for openjdk package installation.
